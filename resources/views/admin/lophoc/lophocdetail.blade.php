        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-action">
                        {{-- Nút Xóa Học viên --}}
                        <form action="{{ route('lophoc.removeHocVien', ['lophoc' => $lophoc->id, 'hocvien' => $hv->id]) }}" method="POST" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal fade" id="chuyenLopModal" tabindex="-1" aria-labelledby="chuyenLopModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="chuyenLopForm" action="{{ route('hocvien.transferLop') }}" method="POST">
                    @csrf
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-action">
                        {{-- Nút Xóa Học viên --}}
                        <form action="{{ route('lichhoc.destroy', ['lophoc' => $lophoc->id, 'thoikhoabieu' => $item->id]) }}" method="POST" style="display:inline-block;">
                            @csrf
