...
class StaffHocvienController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('staff.hocvien.index', compact('dshocvien', 'newMa'));
    }
    public function destroy($id)
    {
        $hv = HocVien::findOrFail($id);
        $hv->delete();
        return redirect()->route('staff.hocvien')->with('success', 'xoa hoc vien thanh cong!');
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.hocvien')->with('success', 'Thêm học viên mới thành công!');
    }
    public function update(Request $request, HocVien $hocvien)
    {
        ...
        return redirect()->route('staff.hocvien')->with('success', 'Cập nhật học viên thành công!');
    ...
    public function search(Request $request)
    {
        ...
        return view('staff.hocvien.search_results', compact('dshocvien'));
    }
}
