            ...
            <div class="modal-body">
                <form id="paymentForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="amountToPay" name="amount" placeholder="Nhập số tiền học viên muốn đóng" required min="1" readonly>
                    </div>
                    <div class="mb-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.thu-hoc-phi-btn', function(e) {
            ...
            $.ajax({
                url: `/staff/hocphi/get-tuition-info/${classId}/${studentId}`,
                method: 'GET',
        ...
        $('#paymentForm').submit(function(e) {
            ...
            $.ajax({
                url: `/staff/hocphi/process-payment`,
                method: 'POST',
                data: formData,
                success: function(response) {
        ...
        $('#send-message-btn').on('click', function() {
            ...
            $.ajax({
                url: `/staff/hocphi/send-reminders`,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
    ...
    function loadStudents(classId, className) {
        ...
        $.ajax({
            url: '/staff/classes/' + classId + '/students', // Route để lấy danh sách học viên và thông tin học phí
            method: 'GET',
            success: function(response) {
            ...
            students.forEach(function(student) {
                ...
                if (matchesSearch) {
                    ...
                    if (totalTuition === 0) {
                        ...
                        printReceiptBtn = `<a href="/staff/phieuthu/print/${student.id}/${classId}" target="_blank" class="text-primary print-receipt-btn" data-student-id="${student.id}" data-class-id="${classId}">In biên lai</a>`;
