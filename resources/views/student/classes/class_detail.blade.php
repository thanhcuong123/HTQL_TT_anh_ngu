...
<style>
    ...
    .materials-table-container {
        /* Thêm .materials-table-container */
        margin-top: 30px;
    }

    .schedule-table-container h4,
    .materials-table-container h4 {
        /* Thêm .materials-table-container h4 */
        color: #333;
        margin-bottom: 15px;
        font-size: 1.5em;
        display: flex;
    ...
    .materials-table-container h4 i {
        /* Thêm .materials-table-container h4 i */
        margin-right: 10px;
        font-size: 0.9em;
        color: #007bff;
    }
    ...
    .schedule-table td,
    .materials-table th,
    /* Thêm .materials-table th */
    .materials-table td {
        /* Thêm .materials-table td */
    ...
    .materials-table tbody tr:nth-child(even) {
        /* Thêm .materials-table tbody tr:nth-child(even) */
        background-color: #f2f2f2;
    }

    .schedule-table tbody tr:hover,
    .materials-table tbody tr:hover {
        /* Thêm .materials-table tbody tr:hover */
        background-color: #e9ecef;
    }

    .no-schedule-message,
    .no-materials-message {
        /* Thêm .no-materials-message */
    ...
    .nav-tabs .nav-link {
        ...
        margin-bottom: -1px;
        /* Để viền dưới của tab active trùng với viền của tab-content */
        font-weight: bold;
        padding: 10px 20px;
    ...
    .tab-content {
        ...
        border: 1px solid #dee2e6;
        border-top: none;
        /* Ẩn viền trên để nối với tab active */
...
<div class="class-detail-card">
    <div class="mb-4">
        <a href="{{ route('student.classes') }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Quay lại danh sách lớp</a>
    </div>
    <h3>
    ...
    <ul class="nav nav-tabs mb-3" id="classDetailTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="schedule-tab" data-bs-toggle="tab" data-bs-target="#schedule" type="button" role="tab" aria-controls="schedule" aria-selected="false">Lịch học</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="materials-tab" data-bs-toggle="tab" data-bs-target="#materials" type="button" role="tab" aria-controls="materials" aria-selected="false">Tài liệu</button> {{-- NEW TAB --}}
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="classDetailTabsContent">
            ...
            <div class="info-section">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="info-item">
                            <strong>Phòng học:</strong> <span>{{ $lophoc->phonghoc->tenphong ?? 'N/A' }}</span>
                        </div> -->
                    </div>
                    <div class="col-md-6">
                        <div class="info-item">
                        ...
                        <!-- <div class="info-item">
                            <strong>Học phí:</strong> <span>{{ number_format(optional(optional($lophoc->trinhdo)->dongia)->hocphi ?? 0, 0, ',', '.') }} VNĐ</span>
                        </div> -->
                        <!-- <div class="info-item">
        ...
        <div class="tab-pane fade" id="schedule" role="tabpanel" aria-labelledby="schedule-tab">
            <div class="schedule-table-container">
                ...
                <div class="no-schedule-message">
                    <p>Lớp học này chưa có lịch học nào được thiết lập.</p>
                </div>
                @else
                    ...
                    <table class="schedule-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $scheduleItem->phonghoc->tenphong ?? 'N/A' }} -
                                    {{ $scheduleItem->phonghoc->tang->nhahoc->ma ?? 'N/A' }}
                                </td>

                                <td>{{ $scheduleItem->giaovien->ten ?? 'N/A' }}</td>
        ...
        <div class="tab-pane fade" id="materials" role="tabpanel" aria-labelledby="materials-tab">
            <div class="materials-table-container">
                <h4><i class="fas fa-file-alt"></i> Tài liệu lớp học</h4>
                @if($lophoc->taiLieuHocTaps->isEmpty())
                <div class="no-materials-message">
                    <p>Lớp học này hiện chưa có tài liệu nào được chia sẻ.</p>
                </div>
                @else
                <div class="table-responsive">
                    <table class="materials-table">
                        ...
                        <tbody>
                            @foreach($lophoc->taiLieuHocTaps as $index => $material)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $material->tentailieu ?? 'N/A' }}</td>
            ...
            <div class="student-list-section">
                ...
                <div class="student-list">
                    <ul>
                        ...
                        <li><i class="fas fa-user-graduate"></i> {{ $student->ten ?? 'N/A' }}</li>
                        @endforeach
                    </ul>
                </div>
                @endif
...
{{-- Lưu ý: Bootstrap 5 tabs yêu cầu Bootstrap JS bundle.
     Đảm bảo bạn đã nhúng nó trong student.student_index.blade.php hoặc layout chính của bạn.
--}}
