     ...
     <div class="sidebar-popup">
         ...
         <form action="{{ route('staff.hocvien.store') }}" method="POST">
             ...
             <div class="form-group mb-3">
                 ...
                 <input type="email" class="form-control" id="email_user" name="email_hv" placeholder="Nhập email học viên">
             ...
             <div class="form-group mb-3">
                 ...
                 <input type="text" class="form-control" id="diachi_hoc_vien" name="diachi" placeholder="Nhập địa chỉ">
             </div>
             <div class="form-group mb-3">
