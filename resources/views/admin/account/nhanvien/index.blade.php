...
<div class="card">
    <div class="card-body">
        ...
        <form method="GET" class="mb-3 d-flex justify-content-end">
            ...
            <a href="{{ route('admin.nhanvien.accountIndex') }}" class="btn btn-primary ms-2" style="margin-left:20px">Xoá lọc</a>
        </form>
...
<div class="modal fade" id="modalTaoTaiKhoan" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('nhanvien.createAccount') }}" method="POST">
            @csrf
...
<script>
    $('.btn-tao-taikhoan').click(function() {
        ...
        let email = `${toSlug(ten)}${ma}@st.edu.vn`;
