...
<div class="card">
    <div class="card-body">
        ...
        <div class="toolbar mb-3 d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('tuvan') }}" method="GET" class="mb-3 d-flex align-items-end gap-3 flex-wrap">
            ...
            {{-- Form tìm kiếm --}}
            <form class="search-form" action="{{ route('tuvan') }}" method="GET" style="position: relative;">
            ...
            <table class="table table-striped table-bordered align-middle">
                ...
                <tbody id="kq-timkiem">
                    ...
                    <tr>
                        ...
                        <td>{{ $tv->sdt }}</td>
                        <td>{{ $tv->dotuoi }}</td>
                        <td>{{ $tv->khoaHoc->ten ?? 'Không xác định' }}</td>
                        ...
                        <td class="col-action">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-khoahoc="{{ $tv->khoaHoc->ten ?? 'Không xác định' }}"
                            ...
                            <form action="{{ route('tuvan.destroy', $tv->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa yêu cầu tư vấn này?')">
                                @csrf
                                @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editTuVanModalLabel">Cập nhật yêu cầu tư vấn</h5>
...
<script>
    document.querySelectorAll('.btn-sua-tuvan').forEach(button => {
        button.addEventListener('click', function() {
            ...
            form.action = `/admin/tuvan/update/${id}`; // Cập nhật route PUT tương ứng
