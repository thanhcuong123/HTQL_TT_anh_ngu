@extends('staff.index') {{-- Đảm bảo bạn extend layout chính của admin --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="trinhdo_id" id="trinhdo_id" class="form-control" required style="height:45px">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="namhoc_id" id="namhoc" class="form-control" required style="height:45px">
